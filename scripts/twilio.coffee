...
#
# Commands:
#   @bot sms <to> <message> - Sends <message> to the number <to>
#
# Author:
#   caleywoods
#
# Retrieved on 2013-05-13 from https://github.com/github/hubot-scripts/blob/master/src/scripts/sms.coffee
